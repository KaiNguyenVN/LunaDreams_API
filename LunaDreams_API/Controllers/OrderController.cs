using LunaDreams_API.Controllers;
...
namespace LunaDreams_API.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResponse>> CreateOrder([FromBody] OrderHeaderCreate orderHeader)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        OrderDetails orderDetailsDTO = new()
                        {
                        ...
                        _db.OrderDetails.Add(orderDetailsDTO);
                    }
                    _db.SaveChanges();
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<ApiResponse>> UpdateOrderHeader(int id, [FromBody] OrderHeaderUpdate orderHeaderUpdateDTO)
        {
            try
            {
