...
namespace LunaDreams_API.Migrations
{
    ...
    [Migration("20240801061925_tryDeploy")]
    partial class tryDeploy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LunaDreams_API.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("LunaDreams_API.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LunaDreams_API.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("LunaDreams_API.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("LunaDreams_API.Models.OrderHeader", b =>
                {
                    b.HasOne("LunaDreams_API.Models.ApplicationUser", "User")
                        .WithMany()
